...
## plot in png device
png(filename = "D:/Dropbox/nisarg_dss_home/ExData_Plotting1/plot1.png")
with(two_days,hist(Global_active_power,xlab = "Global Active Power (kilowatts)",col="red",main="Global Active Power"))
dev.off()
